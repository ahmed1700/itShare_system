...
export class AuthService {
    ...
    constructor(private http: HttpClient,
        ...
        employeesURL=_url('employeeLogIn');
        TrainerURL=_url('trainerLogIn');

        
    // Authentication/Authorization
    employeeLogin(username: string, password: string,ip:string): Observable<any> {
        return this.http.post<any>(`${this.employeesURL}`, { "email": username,"password": password,'ip':ip})
    }
    loginTrainer(username: string, password: string): Observable<any> {
        
        return this.http.post<any>(`${this.TrainerURL}`, { "email": username,"password": password});
    }
    loggedin() {
    ...
    getToken() {
        ...
        }else if(JSON.parse(localStorage.getItem('currentTrainer'))){
            return JSON.parse(localStorage.getItem('currentTrainer')).token
        }
        else return
    }
