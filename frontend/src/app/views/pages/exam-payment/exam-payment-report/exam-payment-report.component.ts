...
@Component({
  selector: 'kt-exam-payment-report',
  templateUrl: './exam-payment-report.component.html',
  styleUrls: ['./exam-payment-report.component.scss']
})
export class ExamPaymentReportComponent implements OnInit {

  allPayments:ExamStudent[]=[]
  noPayment
  ...
  constructor(
    public dialogRef: MatDialogRef<ExamPaymentReportComponent>,
  ...
  ngOnInit() {
    ...
    this.totalPaid = this.allPayments.reduce((a, b) => +a + +b.totalPrice, 0);
    this.originalPrice= this.allPayments.reduce((a, b) => +a + +b.originalPrice, 0);
